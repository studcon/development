         ...
         {isStudentsAnswersOpen ? (
            ...
            <div className='flex flex-col justify-between h-full'>
               ...
               <div className='flex leading-[3px] text-[15px] self-end mt-[25px]'>
                  ...
                  <button
                     className='bg-lightPurple transition-[0.3s] hover:bg-buttonsHover mr-[10px] hover:transition-[0.3s] w-[130px] h-[45px] flex justify-center items-center rounded-[22px]'
                     onClick={() => updateTest()}
                  >
                     Редактитровать
                  </button>
